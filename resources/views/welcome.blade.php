            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        <ul>
                            <li><span
                                    style="border-radius: 10px; padding: 0px 3px; background-color: rgb(33, 147, 209); color:white;">GET</span>
                                index-----------------------------
                                <b>/api/clients</b>
                            </li>
                            <li><span
                            ...
                            <li><span
                                    style="border-radius: 10px; padding: 0px 3px; background-color: rgb(33, 147, 209); color:white;">GET</span>
                                search----------------------------
                                <b>/api/clients/search/{search}</b>
                            </li>
                            <li><span
                                    style="border-radius: 10px; padding: 0px 3px; background-color: green; color:white;">POST</span>
                                store----------------------------
                                <b>/api/clients/create</b>
                            </li>
                            <li><span
                                    style="border-radius: 10px; padding: 0px 3px; background-color: yellow; color:black;">PUT</span>
                                update---------------------------
                                <b>/api/clients/update/{id}</b>
                            </li>
                            <li><span
                                    style="border-radius: 10px; padding: 0px 3px; background-color: hsl(0, 61%, 50%); color:white;">DELETE</span>
                                destroy------------------------
                                <b>/api//clients/delete/{id}</b>
                            </li>
                        </ul>
                    </div>
                </div>
